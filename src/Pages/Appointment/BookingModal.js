            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-flow-row gap-4 mt-12'>
                        ...
                        <input type="name" name='name' placeholder="Full Name" className="input input-bordered input-md w-full lg:max-w-lg" />
                        <input type="number" name='phone' placeholder="Phone Number" className="input input-bordered input-md w-full lg:max-w-lg" />
                        <input type="email" name='email' placeholder="Email Address" className="input input-bordered input-md w-full lg:max-w-lg" />
